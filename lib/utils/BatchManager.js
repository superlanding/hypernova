  ...
  _createClass(BatchManager, [{
    ...
    value: function () {
      function render(token) {
        ...
        return _promise2['default'].resolve(result).then(function (renderFn) {
          // ensure that we have this component registered
          if (!renderFn || typeof renderFn !== 'function') {
            // component not registered
            context.statusCode = 404;
            return _promise2['default'].reject(notFound(name));
          }
          ...
          if (!html) {
            return _promise2['default'].reject(noHTMLError);
          }
          context.html = html;
